...
def validate_env_variables(env_vars):
    ...
    required_vars = ['CDF_PROJECT', 'CDF_CLUSTER', 'CDF_CLIENT_ID', 'CDF_CLIENT_SECRET', 'CDF_TENANT_ID']
...
def setup_env_file():
    ...
    print("- CDF_BASE_URL: Your CDF base URL (usually https://your-cluster.cognitedata.com)")
