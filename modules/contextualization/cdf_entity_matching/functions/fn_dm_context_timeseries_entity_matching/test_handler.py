...
class TestHandler:
    ...
    def test_handle_success(
        self, mock_asset_matching, mock_load_config, mock_logger_class
    ):
        ...
        # Test data
        test_data = {"logLevel": "INFO", "ExtractionPipelineExtId": "test_pipeline"}
    ...
    @patch("handler.load_config_parameters")
    @patch("handler.asset_entity_matching")
    def test_handle_with_custom_log_level(
        self, mock_asset_matching, mock_load_config, mock_logger_class
    ):
        ...
        test_data = {"logLevel": "DEBUG", "ExtractionPipelineExtId": "test_pipeline"}
    ...
    @patch("handler.load_config_parameters")
    @patch("handler.asset_entity_matching")
    def test_handle_default_log_level(
        self, mock_asset_matching, mock_load_config, mock_logger_class
    ):
        ...
        test_data = {"ExtractionPipelineExtId": "test_pipeline"}
    ...
    @patch("handler.load_config_parameters")
    @patch("handler.asset_entity_matching")
    def test_handle_config_loading_failure(
        self, mock_asset_matching, mock_load_config, mock_logger_class
    ):
    ...
    @patch("handler.load_config_parameters")
    @patch("handler.asset_entity_matching")
    def test_handle_asset_matching_failure(
        self, mock_asset_matching, mock_load_config, mock_logger_class
    ):
    ...
    def test_handle_no_logger_creation_on_exception(
        self, mock_print, mock_logger_class
    ):
...
class TestIntegration:
    ...
    @patch("handler.load_config_parameters")
    @patch("handler.CogniteFunctionLogger")
    def test_handle_integration_flow(
        self, mock_logger_class, mock_load_config, mock_asset_matching
    ):
