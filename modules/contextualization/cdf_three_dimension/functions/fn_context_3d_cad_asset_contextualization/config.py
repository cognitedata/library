...
class Config(BaseModel, alias_generator=to_camel):
    ...
    @property
    def skip_demo_nodeids(self) -> bool:
        return self.data.parameters.skip_demo_nodeids
...
def resolve_dm_cad_contextualization_config(config: Config) -> DMCadContextualizationConfig:
    ...
    skip_demo_nodeids = bool(_get_opt(config, "skip_demo_nodeids", False))
    ...
    return DMCadContextualizationConfig(
        ...
        skip_demo_nodeids=skip_demo_nodeids,
