...
export const nb: Messages = {
  ...
  "persistence.canvasHint":
    "Fan-in-sammenslåing og retningslinjer per egenskap gjelder når flere greiner møtes i én lagringsnode.",
  ...
  "runResults.hint":
    "Discovery-arbeidsflytrapportar under local_run_results/ for målet valgt i sidemenyen. Berre køyringer frå det målet; eldre filer utan metadata vert skjulte med trigger. Fjerne CDF-køyringer skriv ikkje her.",
  "runResults.refresh": "Oppdater liste",
  "runResults.runLabel": "Kjøring",
  "runResults.emptyDiscovery":
    "Ingen lokale discovery-kjørerapporter for dette omfanget. Kjør discovery-arbeidsflyten lokalt først.",
  "runResults.noRawInReport":
    "Denne rapporten har ingen raw_results.tables (tom kjøring eller RAW-utvalg ikke vedlagt).",
  "runResults.rawTableSelect": "RAW-tabell",
  "runResults.discoveryRawHint":
    "Forhåndsvisning av utvalgte RAW-instansrader fra rapporten (raw_results.tables). Åpne rå JSON for hele filen.",
  "runResults.rawTruncated": "Avkortet ved radgrense",
  "runResults.totalRows": "{count} rader",
  "runResults.showing": "Viser {from}–{to} av {total}",
  "runResults.filterPlaceholder": "Filtrer innlastede rader (JSON)",
  "runResults.loadMore": "Last inn mer",
  "runResults.error": "Kunne ikke laste resultater.",
  "runResults.table.rowKey": "Radnøkkel",
  "runResults.table.columnValues": "Kolonneverdier (JSON)",
  ...
  "flow.inspectorAliasPersistenceHint":
    "Tilsvarer fn_dm_view_save: leser aliasing-RAW og skriver aliaslister (valgfritt FK-strenger) til describable-instanser. Konfigurer tilbakeskriving i scope eller oppgavedata.",
