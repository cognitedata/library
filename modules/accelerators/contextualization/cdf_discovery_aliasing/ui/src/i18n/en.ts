...
export const en: Messages = {
  ...
  "flow.inspectorInvertedIndexHint":
    "Maps to fn_dm_inverted_index: writes contextualization inverted-index entries (DM InvertedIndexEntry or RAW scoped postings) from predecessor task snapshots.",
