...
export function KeyExtractionControls({
  ...
  return (
    <div className="discovery-key-discovery">
      <h3 className="discovery-section-title">{t("keyExtraction.title")}</h3>
      ...
      {editorSub === "validation" && (
        <div role="tabpanel">
          ...
          <p className="discovery-hint">{t("keyExtraction.validationYamlHint")}</p>
