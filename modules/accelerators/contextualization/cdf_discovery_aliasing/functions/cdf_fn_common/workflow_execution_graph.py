"""
Declarative macro execution graph (Kahn-style process network) for cdf_discovery_aliasing.
...
FUNCTION_CHANNEL_METADATA: Mapping[str, Mapping[str, Any]] = {
    "fn_dm_view_save": {
        "inputs": ["predecessor payloads", "configuration", "task_id"],
        "outputs": ["DM instances.apply (cohort properties)"],
    },
    "fn_dm_raw_save": {
        "inputs": ["predecessor payloads", "configuration", "task_id"],
        "outputs": ["RAW cohort replication to task sink"],
    },
    "fn_dm_classic_save": {
        "inputs": ["predecessor payloads", "configuration", "task_id"],
        "outputs": ["classic assets/files/time_series update"],
    },
    "fn_dm_view_query": {
    ...
    "fn_dm_join": {
        "inputs": ["two predecessor RAW cohort sinks (left/right)", "configuration", "task_id"],
        "outputs": ["join sink RAW (merged cohort rows)"],
    },
    "fn_dm_validate": {
        "inputs": ["predecessor RAW sinks", "configuration", "task_id"],
...
_FN_TO_ROLE: Dict[str, str] = {
    "fn_dm_view_save": "save_view",
    "fn_dm_raw_save": "save_raw",
    "fn_dm_classic_save": "save_classic",
...
EXECUTION_GRAPH_FILE_HEADER = (
    "# IR-derived Kahn-style execution graph for cdf_discovery_aliasing.\n"
