...
2. The **`cdf_discovery_aliasing`** package directory (parent of **`ui/server/`**).
...
```bash
cd modules/accelerators/contextualization/cdf_discovery_aliasing
...
```bash
cd modules/accelerators/contextualization/cdf_discovery_aliasing/ui
