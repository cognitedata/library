...
def run_local():
    ...
    token_uri = os.getenv("IDP_TOKEN_URL")
    ...
    pipeline_ext_id = os.getenv("EXTRACTION_PIPELINE_EXT_ID", "ep_ctx_3d_clov_navisworks_annotation")
    data = {"ExtractionPipelineExtId": pipeline_ext_id}
    handle(data, client)
