...
def write_mapping_to_raw(
    ...
    for match in good_matches:
        ...
        raw_uploader.add_to_upload_queue(config.rawdb, config.raw_table_all, Row(match["nodeId"], match))
    ...
    for not_match in bad_matches:
        ...
        raw_uploader.add_to_upload_queue(config.rawdb, config.raw_table_all, Row(not_match["nodeId"], not_match))
