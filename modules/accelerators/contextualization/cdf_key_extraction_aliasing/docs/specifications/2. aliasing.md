...
- **Full reference**: [Configuration guide — § Alias mapping table (RAW catalog)](../guides/configuration_guide.md#14-alias-mapping-table-raw-catalog) (`raw_table`, `scope`, `source_match`, `main.py` / `AliasingEngine` client requirement).
