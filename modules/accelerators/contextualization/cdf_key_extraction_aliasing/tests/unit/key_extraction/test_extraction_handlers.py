...
from modules.accelerators.contextualization.cdf_key_extraction_aliasing.functions.fn_dm_key_extraction.logger import (
...
class TestExtractionMethods(unittest.TestCase):
    ...
    def test_regex_extraction_handler(self):
        ...
        rule = ExtractionRule(
            ...
            handler=ExtractionMethod.REGEX,
    ...
    def test_fixed_width_extraction_handler(self):
        ...
        rule = ExtractionRule(
            ...
            extraction_type=ExtractionType.CANDIDATE_KEY,
            handler=ExtractionMethod.FIXED_WIDTH,
    ...
    def test_token_reassembly_handler(self):
        ...
        rule = ExtractionRule(
            ...
            extraction_type=ExtractionType.CANDIDATE_KEY,
            handler=ExtractionMethod.TOKEN_REASSEMBLY,
            pattern="",
            priority=50,
            enabled=True,
            min_confidence=0.7,
    ...
    def test_heuristic_handler(self):
        ...
        rule = ExtractionRule(
            ...
            extraction_type=ExtractionType.CANDIDATE_KEY,
            handler=ExtractionMethod.HEURISTIC,
            pattern="",
            priority=50,
            enabled=True,
            min_confidence=0.7,
    ...
    def test_passthrough_extraction_handler(self):
        ...
        rule = ExtractionRule(
            ...
            extraction_type=ExtractionType.CANDIDATE_KEY,
            handler=ExtractionMethod.PASSTHROUGH,
            pattern="",
            priority=50,
            enabled=True,
            min_confidence=0.95,
