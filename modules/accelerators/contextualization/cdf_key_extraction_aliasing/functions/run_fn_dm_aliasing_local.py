...
Custom input/output:
  poetry run python modules/accelerators/contextualization/cdf_key_extraction_aliasing/functions/run_fn_dm_aliasing_local.py \
    ...
    --config-path modules/accelerators/contextualization/cdf_key_extraction_aliasing/extraction_pipelines/ctx_aliasing_GEL_prod.config.yaml
"""
...
def main() -> int:
    ...
    default_aliasing_config = (
        module_dir / "extraction_pipelines" / "ctx_aliasing_GEL_prod.config.yaml"
    )
