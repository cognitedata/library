...
Documentation for **`key_extraction_aliasing_jonluca`** (`modules/accelerators/contextualization/key_extraction_aliasing_jonluca/`).
...
- [EXTRACTION_PIPELINE_REDUNDANCY_REPORT.md](EXTRACTION_PIPELINE_REDUNDANCY_REPORT.md) — internal analysis (if present)
- [aliasing_simplification_analysis.md](aliasing_simplification_analysis.md) — internal notes (if present)
