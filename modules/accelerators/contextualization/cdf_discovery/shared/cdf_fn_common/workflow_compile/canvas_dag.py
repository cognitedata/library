...
_KIND_SPEC: Dict[str, Tuple[str | None, str, str]] = {
    "query_view": ("fn_discovery_etl_view_query", "query_view", "function"),
    "query_raw": ("fn_discovery_etl_raw_query", "query_raw", "function"),
    "query_classic": ("fn_discovery_etl_classic_query", "query_classic", "function"),
    "query_sql": ("fn_discovery_etl_sql_query", "query_sql", "function"),
    "query_records": ("fn_discovery_etl_records_query", "query_records", "function"),
    "transform": ("fn_discovery_etl_transform", "transform", "function"),
    "filter": ("fn_discovery_etl_filter", "filter", "function"),
    "json_mapping": (None, "json_mapping", "jsonMapping"),
    "instance_filter": ("fn_discovery_etl_filter", "filter", "function"),
    "score": ("fn_discovery_etl_score", "score", "function"),
    "validation": ("fn_discovery_etl_score", "score", "function"),
    "join": ("fn_discovery_etl_join", "join", "function"),
    "merge": ("fn_discovery_etl_merge", "merge", "function"),
    "build_index": ("fn_discovery_etl_build_index", "build_index", "function"),
    "file_annotation": ("fn_discovery_etl_file_annotation", "file_annotation", "function"),
    "workflow_fanout_plan": ("fn_discovery_etl_fanout_plan", "workflow_fanout_plan", "function"),
    "save_view": ("fn_discovery_etl_view_save", "save_view", "function"),
    "save_raw": ("fn_discovery_etl_raw_save", "save_raw", "function"),
    "save_classic": ("fn_discovery_etl_classic_save", "save_classic", "function"),
    "save_records": ("fn_discovery_etl_records_save", "save_records", "function"),
    "save_stream": ("fn_discovery_etl_stream_save", "save_stream", "function"),
    ...
    "raw_cleanup": ("fn_discovery_etl_raw_cleanup", "raw_cleanup", "function"),
}
...
def etl_local_pipeline_specs() -> Dict[str, Tuple[str, str]]:
    ...
    _extra_local: Dict[str, str] = {
        "fn_discovery_etl_file_annotation": "file_annotation",
        "fn_discovery_etl_file_annotation_launch": "file_annotation_launch",
        "fn_discovery_etl_file_annotation_finalize": "file_annotation_finalize",
        "fn_discovery_etl_file_annotation_barrier": "file_annotation_barrier",
    }
