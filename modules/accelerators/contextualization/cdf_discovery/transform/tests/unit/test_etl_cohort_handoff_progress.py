"""Cohort RAW handoff emits canvas task_progress every 500 rows."""
...
def test_write_entity_rows_emits_progress_every_500(monkeypatch) -> None:
    emitted: list[int] = []
    ...
    assert captured == [(500, 501), (501, 501)]
