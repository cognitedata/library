"""CDF transformations SQL preview (query/run API) — shared by operator UI and ``fn_dm_sql_query``."""
...
def run_sql_preview(
    ...
    *,
    ...
    """Preview SQL using CDF transformations ``preview`` (20230101-beta run query API)."""
    q = query.strip()
    if not q:
