export const BUILD_METRICS: { key: string; labelKey: string }[] = [
...
export const QUERY_SUMMARY_METRICS: { key: string; labelKey: string }[] = [
...
export const REUSE_METRICS: { key: string; labelKey: string }[] = [
...
export const TAG_REUSE_METRICS: { key: string; labelKey: string }[] = [
...
export const TARGET_DRIVEN_METRICS: { key: string; labelKey: string }[] = [
...
export const DASHBOARD_SUMMARY_METRICS: { key: string; labelKey: string }[] = [
...
export const DASHBOARD_DELTA_METRICS: { key: string; labelKey: string }[] = [
