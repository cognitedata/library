...
export function FieldPoliciesEditor({
  ...
  return (
    <div className="discovery-field-policies-editor">
      <h4 className="gov-modal__title" style={{ fontSize: "0.95rem", marginTop: 0, marginBottom: "0.5rem" }}>
        {t(sectionTitleKey)}
      </h4>
      <p className="transform-node-editor-modal__hint" style={{ marginTop: 0, marginBottom: "0.65rem" }}>
        {t(emptyHintKey)}
      </p>
      ...
      {policyRows.map((row, i) => (
        ...
        >
          ...
          >
            <label className="gov-label" style={{ flex: "1 1 10rem", minWidth: "8rem" }}>
            ...
            <label className="gov-label" style={{ flex: "0 1 11rem" }}>
          ...
          {row.strategy === "merge_list" ? (
            ...
            >
              ...
              <label className="gov-label" style={{ flex: "0 1 12rem", marginBottom: 0 }}>
      ...
      <div style={{ marginTop: "1rem" }}>
        ...
        {advancedJsonOpen ? (
          <p className="transform-node-editor-modal__hint" style={{ marginTop: "0.35rem", marginBottom: 0 }}>
        ...
        {advancedJsonOpen ? (
          <div style={{ marginTop: "0.5rem" }}>
            ...
            {policiesError ? <p className="transform-node-editor-modal__hint transform-node-editor-modal__hint--warn">{policiesError}</p> : null}
          </div>
        ) : null}
      </div>
    </div>
