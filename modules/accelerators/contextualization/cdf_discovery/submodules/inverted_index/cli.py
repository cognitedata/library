...
Requires CDF credentials in .env (repo root or module directory).
  ...
  python module.py invoke-fn fn_discovery_idx_build_metadata --data '{"dry_run":true}'
...
def cmd_invoke_fn(args: argparse.Namespace) -> int:
    ...
    mapping = {
        "fn_discovery_idx_build_metadata": "fn_discovery_idx_build_metadata.handler",
        "fn_discovery_idx_build_annotations": "fn_discovery_idx_build_annotations.handler",
        "fn_discovery_idx_target_driven": "fn_discovery_idx_target_driven.handler",
        "fn_discovery_idx_handle_subscription": "fn_discovery_idx_handle_subscription.handler",
        "fn_discovery_idx_handle_source_metadata": "fn_discovery_idx_handle_source_metadata.handler",
        "fn_discovery_idx_build_watermark_incremental": "fn_discovery_idx_build_watermark_incremental.handler",
        "fn_discovery_idx_score": "fn_discovery_idx_score.handler",
        "fn_discovery_idx_deltas": "fn_discovery_idx_deltas.handler",
        "fn_discovery_idx_upsert_detections": "fn_discovery_idx_upsert_detections.handler",
        "fn_discovery_idx_index_metadata_instance": "fn_discovery_idx_index_metadata_instance.handler",
    }
    module_path = mapping.get(fn_id)
    if not module_path:
        print(f"Unknown function id: {fn_id}", file=sys.stderr)
        return 1
    functions_dir = _PACKAGE_ROOT.parent / "submodules/transform/functions"
...
def main(argv: list[str] | None = None) -> int:
    ...
    inv.add_argument("function_id", help="Function externalId (e.g. fn_discovery_idx_build_metadata)")
