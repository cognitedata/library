...
def test_build_index_in_memory(_sink: MagicMock, _flush: MagicMock) -> None:
    ...
    summary = etl_handle_build_index("fn_discovery_etl_build_index", data, None, None)
...
@patch("cdf_fn_common.etl_save_apply.persist_index_entries_via_adapter")
...
def test_persist_inverted_index_save(mock_rows: MagicMock, mock_persist: MagicMock) -> None:
    mock_rows.return_value = [
        {
            ...
            "columns": {
                ...
                "POSTINGS_JSON": (
                    ...
                    '"view_external_id":"CogniteAsset","source_property":"indexKey"}]'
                ),
            },
        }
    ]
    ...
    summary = etl_persist_inverted_index_save("fn_discovery_etl_raw_save", data, client, None)
