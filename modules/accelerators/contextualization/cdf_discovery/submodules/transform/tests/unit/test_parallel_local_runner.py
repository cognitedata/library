...
def test_dynamic_fanout_parallel_children() -> None:
    ...
    compiled_child_specs = [
        {
            ...
            "parameters": {
                "function": {
                    "externalId": "fn_discovery_etl_file_annotation",
    ...
    with patch.object(dynamic_fanout, "etl_local_pipeline_specs", return_value={"fn_discovery_etl_file_annotation": ("x", "y")}), patch.object(
