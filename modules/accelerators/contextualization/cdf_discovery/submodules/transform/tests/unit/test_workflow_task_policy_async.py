...
def test_default_etl_function_policy_skip_task():
    pol = discovery_task_workflow_policy("fn_discovery_etl_view_query")
    assert pol["onFailure"] == "abortWorkflow"


def test_diagram_batch_policy_async():
    pol = discovery_task_workflow_policy("fn_discovery_etl_file_annotation")
    assert pol["isAsyncComplete"] is True
    assert pol["onFailure"] == "abortWorkflow"
    launch_pol = discovery_task_workflow_policy("fn_discovery_etl_file_annotation_launch")
    finalize_pol = discovery_task_workflow_policy("fn_discovery_etl_file_annotation_finalize")
    barrier_pol = discovery_task_workflow_policy("fn_discovery_etl_file_annotation_barrier")
