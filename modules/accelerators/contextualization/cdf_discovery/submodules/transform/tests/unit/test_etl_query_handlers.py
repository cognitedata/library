...
from fn_discovery_etl_classic_query.handler import etl_handle_query_classic  # noqa: E402
from fn_discovery_etl_raw_query.handler import etl_handle_query_raw  # noqa: E402
from fn_discovery_etl_sql_query.handler import etl_handle_query_sql  # noqa: E402
...
def test_etl_handle_query_classic_applies_filters() -> None:
    ...
    summary = etl_handle_query_classic("fn_discovery_etl_classic_query", data, client, None)
    assert summary["instances_written"] == 1
    assert summary["query_scope_mode"] == "inherit"
...
def test_etl_handle_query_sql_maps_external_id_column() -> None:
    ...
    summary = etl_handle_query_sql("fn_discovery_etl_sql_query", data, client, None)
...
def test_etl_handle_query_raw_reads_predecessor_buffer_without_source() -> None:
    ...
    summary = etl_handle_query_raw("fn_discovery_etl_raw_query", data, None, None)
    assert summary["instances_written"] == 1
    assert summary["query_scope_mode"] == "inherit"
