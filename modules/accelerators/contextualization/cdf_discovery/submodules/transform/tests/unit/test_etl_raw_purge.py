...
from fn_discovery_etl_raw_cleanup.handler import etl_handle_raw_cleanup  # noqa: E402
...
@patch("fn_discovery_etl_raw_cleanup.handler.run_etl_raw_cleanup_action")
def test_handler_returns_ok(mock_action) -> None:
    ...
    out = etl_handle_raw_cleanup("fn_discovery_etl_raw_cleanup", data, MagicMock(), None)
...
def test_workflow_policy_cleanup_skip_task() -> None:
    ...
    pol = discovery_task_workflow_policy("fn_discovery_etl_raw_cleanup")
