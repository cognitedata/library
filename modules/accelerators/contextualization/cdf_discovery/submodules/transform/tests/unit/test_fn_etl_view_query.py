"""Unit tests for fn_discovery_etl_view_query incremental index cache and skip path."""
...
from fn_discovery_etl_view_query.handler import (  # noqa: E402
...
def test_hash_skip_does_not_queue_incremental_upsert(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.query_all_view_instances",
        _fake_query,
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.read_watermark_high_ms",
        lambda *_a, **_k: 1000,
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.incremental_state_table_exists",
        lambda *_a, **_k: True,
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.load_incremental_hashes_for_nodes",
        lambda *_a, **_k: {"sp1:ext1": "same_hash", "sp1:uuid-1": "same_hash"},
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.row_content_hash",
        lambda _props: "same_hash",
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.upsert_incremental_entity_hashes_raw",
        lambda *_a, **kwargs: upsert_calls.append(kwargs),
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.write_incremental_watermark_raw",
        lambda *_a, **_k: None,
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.maybe_handoff_predecessor_rows",
        lambda *_a, **_k: None,
    )
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.resolve_incremental_state_sink",
    ...
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.save_query_checkpoint_state",
        lambda *_a, **_k: None,
    )
...
def test_view_query_uses_checkpoint_cursor_and_run_cap(monkeypatch) -> None:
    ...
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.load_query_checkpoint_state", lambda *_a, **_k: SimpleNamespace(rows_completed=0, is_complete=False, continuation_token="cursor-1"))
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.save_query_checkpoint_state", lambda *_a, **kwargs: saved.update(kwargs))
...
def test_view_query_lookup_full_scan_skips_checkpoint(monkeypatch) -> None:
    ...
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.load_query_checkpoint_state", _load)
...
def test_rule_change_reprocesses_even_when_source_props_unchanged(monkeypatch) -> None:
    ...
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.query_all_view_instances", _fake_query)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.incremental_state_table_exists", lambda *_a, **_k: True)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.read_watermark_high_ms", lambda *_a, **_k: None)
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.load_incremental_hashes_for_nodes",
        lambda *_a, **_k: {"sp1:uuid-1": prev_hash},
    )
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.upsert_incremental_entity_hashes_raw", lambda *_a, **_k: None)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.write_incremental_watermark_raw", lambda *_a, **_k: None)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.maybe_handoff_predecessor_rows", lambda *_a, **_k: None)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.resolve_incremental_state_sink", lambda *_a, **_k: ("db", "tbl"))
    monkeypatch.setattr(
        "fn_discovery_etl_view_query.handler.load_query_checkpoint_state",
        lambda *_a, **_k: SimpleNamespace(rows_completed=0, is_complete=False, continuation_token=""),
    )
...
def test_missing_incremental_table_disables_per_row_state_reads(monkeypatch) -> None:
    ...
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.query_all_view_instances", _fake_query)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.incremental_state_table_exists", lambda *_a, **_k: False)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.read_watermark_high_ms", lambda *_a, **_k: 1000)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.load_incremental_hashes_for_nodes", _load_hashes)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.row_content_hash", lambda _props: "new_hash")
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.upsert_incremental_entity_hashes_raw", lambda *_a, **_k: None)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.write_incremental_watermark_raw", lambda *_a, **_k: None)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.maybe_handoff_predecessor_rows", lambda *_a, **_k: None)
    monkeypatch.setattr("fn_discovery_etl_view_query.handler.resolve_incremental_state_sink", lambda *_a, **_k: ("db", "tbl"))
