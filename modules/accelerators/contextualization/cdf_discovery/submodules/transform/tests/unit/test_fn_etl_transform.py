"""Integration tests for fn_discovery_etl_transform handler."""

from __future__ import annotations

from cdf_fn_common import etl_ui_progress
from fn_discovery_etl_transform.handler import etl_handle_transform
...
def test_transform_trim_whitespace_writes_aliases() -> None:
    ...
    summary = etl_handle_transform("fn_discovery_etl_transform", data, client=None, log=None)
