...
def test_view_save_uses_cohort_space_over_pipeline_default(
    ...
    summary = etl_apply_view_save("fn_discovery_etl_view_save", data, client, None)
...
def test_view_save_in_memory_via_predecessor_rows(_mock_pred: MagicMock) -> None:
    ...
    summary = etl_apply_view_save("fn_discovery_etl_view_save", data, None, None)
...
def test_classic_save_dry_run(mock_iter_rows: MagicMock, _mock_pred: MagicMock) -> None:
    ...
    summary = etl_apply_classic_save("fn_discovery_etl_classic_save", data, client, None)
