...
- Total row cap: `query_enumeration.resolve_view_query_limit` (`limit` / `read_limit`; default 1000, `0` = unlimited)

See `fn_discovery_etl_view_query/handler.py` for the Cognite Function entry point.
