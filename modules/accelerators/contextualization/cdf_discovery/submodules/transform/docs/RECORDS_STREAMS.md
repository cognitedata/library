...
|------|----------|---------|
| `query_records` | `fn_discovery_etl_records_query` | Paginated sync/filter read → cohort RAW |
| `save_records` | `fn_discovery_etl_records_save` | Ingest / upsert / delete from cohort rows |
| `save_stream` | `fn_discovery_etl_stream_save` | Create stream (`POST /streams`) |
