...
class SplitJoinHandler(AbstractTransformHandler):
    ...
    description = (
        "Split the working string by delimiter, then reassemble selected token indexes via a {0} template "
        "or indexes[] + join. Combines split_string-style parsing with structured output shaping."
    )
