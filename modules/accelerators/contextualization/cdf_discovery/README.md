...
```bash
python modules/accelerators/contextualization/cdf_discovery/module.py build [--config submodules/governance/default.config.yaml] [--dry-run] [--force]
