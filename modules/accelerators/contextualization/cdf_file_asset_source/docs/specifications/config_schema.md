# Configuration schema — `cdf_file_asset_source`

Exhaustive YAML field reference for `default.config.yaml` (`file_asset_source.extract`, `create`, `write`, and `scope_hierarchy`).

**Overview:** [MODULE_SPECIFICATION.md](../MODULE_SPECIFICATION.md). **Quickstart:** [guides/howto_quickstart.md](../guides/howto_quickstart.md).
...
storage:
  database: db_file_asset_extract
  tables:
    results: extract_assets_by_pattern_results
    assets: file_asset_extract_assets
