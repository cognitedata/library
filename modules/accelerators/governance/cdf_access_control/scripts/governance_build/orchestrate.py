...
def run_build_spaces(
    *,
    ...
    if not cfg["scope_dimension"]:
        raise ValueError("spaces.scope_dimension (or legacy spaces.from_dimension) is required")
    ...
    levels, rows, combos = shared_hierarchy_job(
        dimensions,
        scope_dimension=cfg["scope_dimension"],
...
def run_build_groups(
    *,
    ...
    if not merged["scope_dimension"]:
        raise ValueError("groups.scope_dimension is required (or groups.expansion.scope_dimension)")
    ...
    levels, rows, combos = shared_hierarchy_job(
        dimensions,
        scope_dimension=merged["scope_dimension"],
        combine_with=combine_with,
