...
pip install -r modules/solutions/cdf_ai_extractor/functions/fn_ai_property_extractor/requirements.txt
...
```bash
cd modules/solutions/cdf_ai_extractor/functions/fn_ai_property_extractor
python handler.py
```
...
```bash
cdf clean --include solutions/cdf_ai_extractor
```
