 ...
 * `modules/datamodels/cfihos_oil_and_gas_extension` composed domain model (dm_dom_oil_and_gas /
 ...
 * @see https://github.com/cognitedata/library/tree/main/modules/datamodels/cfihos_oil_and_gas_extension
 */
