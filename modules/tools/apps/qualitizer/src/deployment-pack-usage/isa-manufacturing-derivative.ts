 ...
 * `modules/datamodels/isa_manufacturing_extension` SLA/EDM (same ISA view set as SLM).
 * @see https://github.com/cognitedata/library/tree/main/modules/datamodels/isa_manufacturing_extension
 */
