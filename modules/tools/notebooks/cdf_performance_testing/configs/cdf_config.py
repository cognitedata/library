...
class CDFConfig:
    ...
    def __init__(self):
        ...
        self.base_url = os.getenv(
            "CDF_BASE_URL", f"https://{self.cluster}.cognitedata.com"
        )
        ...
        self.default_warmup_iterations = int(
            os.getenv("DEFAULT_WARMUP_ITERATIONS", "2")
        )
        ...
        self.save_detailed_results = (
            os.getenv("SAVE_DETAILED_RESULTS", "True").lower() == "true"
        )
