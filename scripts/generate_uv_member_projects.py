...
PACKAGE_SPECS: list[dict[str, object]] = [
    ...
    {
        "path": "modules/contextualization/cdf_entity_matching/functions/fn_dm_context_entity_matching_submit",
        "name": "fn-dm-context-entity-matching-submit",
        "requires_python": ">=3.11,<3.14",
        "dependencies": [
            "cognite-extractor-utils>=7",
            "cognite-sdk>=7,<8",
    ...
    {
        "path": "modules/contextualization/cdf_entity_matching/functions/fn_dm_context_entity_matching_collect",
        "name": "fn-dm-context-entity-matching-collect",
        "requires_python": ">=3.11,<3.14",
        "dependencies": [
            "cognite-extractor-utils>=7",
            "cognite-sdk>=7,<8",
